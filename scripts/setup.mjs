...
console.log("4. Run: npm run office:check");
console.log("5. Reopen this repository in Codex and trust the project.");
console.log("6. Let Playwright open Chrome and sign in to Kintone once when asked.");
console.log("7. Start a new chat and say: hello");
